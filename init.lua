...
--  See `:help 'clipboard'`
--
-- NOTE: Disabling this makes clipboard a standalone buffer,
-- doesn't effect mouse mode.
...
require('lazy').setup({
  ...
  { -- PLUGIN: Fuzzy Finder (files, lsp, etc)
  ...
  -- Highlight todo, notes, etc in comments
  {
    ...
    opts = {
      ...
      keywords = {
        ...
        TODO = { icon = ' ', color = 'info', alt = { 'TBD', 'WIP' } },
        HACK = { icon = ' ', color = 'warning' },
        WARN = { icon = ' ', color = 'warning', alt = { 'WARNING', 'XXX' } },
        PERF = { icon = ' ', alt = { 'OPTIM', 'PERFORMANCE', 'OPTIMIZE' } },
        NOTE = { icon = ' ', color = 'hint', alt = { 'INFO', 'NOTICE', 'TIP' } },
        TEST = { icon = '⏲ ', color = 'test', alt = { 'TESTING', 'PASSED', 'FAILED' } },
        SECTION = { icon = '#', alt = { 'PLUGIN', 'MOD', 'CONFIG' } },
      },
      highlight = {
        multiline = false, -- disable multine highlight
      },
    },
  },
  ...
  { -- Collection of various small independent plugins/modules
    ...
    config = function()
      ...
      -- Notify: Show one or more highlighted notifications in a single floating window
      require('mini.notify').setup()

      -- Trailspace enhance: Highlighting and more
  ...
  { -- PLUGIN: Better status line and tagline
    ...
    config = function()
      require('lualine').setup {
        ...
        sections = {
          ...
          lualine_z = { 'progress', '%l,%c,%v' },
        },
        tabline = {
          lualine_a = { { 'buffers', show_filename_only = false } },
          lualine_b = { { 'tabs', mode = 1, path = 2 } },
        },
        inactive_winbar = {},
        extensions = {},
      }
